...
if __name__ == "__main__":
    ...
    resultado_assunto = recupera_assunto('Reunião')
    print_resultado("Mensagens com o assunto 'Reunião'", resultado_assunto)

    
    print("\nSimulando a recuperação de mensagens por destinatário:")
    resultado_destinatario = recupera_destinatario('usuario1@example.com')
    print_resultado("Mensagens para 'usuario1@example.com'", resultado_destinatario)
